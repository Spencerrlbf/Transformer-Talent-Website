...
/** Null means no task belongs to this organization; false means storage failed. */
export async function deleteTask(orgId: string, id: string): Promise<boolean | null> {
