-- Candidate vector -> org roles, over the faceted job_embeddings (best facet
-- per role wins). Used by the nightly precompute worker; small table, no ANN
-- index needed until role count grows past ~50k vectors.
