...
case "$DB" in person_atomic_test|person_intake_test|person_refresh_test|person_directory_test|person_recruiter_test|person_published_test|person_derivative_test|person_audit_test) ;; *) exit 2;; esac
PSQL="${PSQL:-psql}"
