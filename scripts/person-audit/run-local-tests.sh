...
q -d person_audit_test -1 -f supabase/migrations/20260926082012_person_audit_writer_guards.sql
...
LOCAL_DATABASE_URL="postgresql://postgres@127.0.0.1:$PORT/person_audit_test" node --test scripts/person-audit/test-guard.mjs

LOCAL_DATABASE_URL="postgresql://postgres@127.0.0.1:$PORT/person_audit_test" node --test scripts/person-audit/test-writer-guards.mjs
