...
const NOT_A_COMPANY = /\b(stealth|self[- ]?employed|freelanc\w*|independent|consultant|contractor|university|college|school|institute of technology|academy|laboratory|club|careers|hiring|untitled|coming soon|\.edu|uc berkeley|berkeley|stanford|cornell|harvard|caltech|princeton|columbia|georgia tech|open source|bootcamp|fellowship)\b|^(none|n\/a|unemployed|retired|student|various|ucla|ucsd|ucsf|mit|ieee|nyu|galvanize|insight data science|general assembly|hack reactor|app academy|flatiron school|teksystems)$/i;
