...
-- ---------------------------------------------------------------------------
-- 6. A manual choice keeps newer good verification over an undated bad check
-- ---------------------------------------------------------------------------
do $$
declare r jsonb;
begin
  ...
  raise notice 'PASS 6 manual choice keeps newer dated good verification; contacts_only leaves header and lists';
end $$;
